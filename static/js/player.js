/**
 * LinguaPlay — Player Controller Module (player.js)
...
/**
 * Initialize YouTube Iframe API loader promise
 */
 ...
 * @param {Function} timeUpdateHandler
 */
...
/**
 * Load a local video File object into the native video player
 * @param {File} file
 */
...
/**
 * Load a YouTube video ID into the YouTube player iframe
 * @param {string} videoId
 * @param {Function} onErrorCallback - Optional error handler
...
export async function loadYouTubeVideo(videoId, onErrorCallback = null) {
  ...
  return new Promise((resolve) => {
    // If player already initialized and ready, use loadVideoById
